...
related_files: ['scripts/testing/functional_tests.py', 'annotations.json', 'transcript_segments.json', '.cursor/mcp.json', 'notes.md', 'data/outputs/logs/archive_telemetry/status.json', 'record.json', 'metadata.json']
---
