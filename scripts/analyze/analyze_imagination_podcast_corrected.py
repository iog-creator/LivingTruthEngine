#!/usr/bin/env python3
"""
Corrected Analysis - Imagination Podcast Transcripts
Using actual methods from existing Living Truth Engine components
"""
...
def analyze_with_correct_methods(transcript_text, video_title, video_id):
    """Analyze using the correct methods from existing components"""
    ...
    try:
        ...
        # Step 4: Use hybrid search for Biblical evidence
        print("📖 Searching for Biblical evidence...")
        biblical_evidence = search_engine.search_biblical_evidence(transcript_text)
        
        # Step 5: Search for survivor testimonies
        print("🎙️ Searching for survivor testimonies...")
        survivor_testimonies = search_engine.search_survivor_testimonies(transcript_text)
        
        # Step 6: Use advanced search for elite networks
        print("🔍 Searching for elite networks...")
        elite_networks = search_engine.search("elite networks", search_type="elite_networks")
...
def main():
    print("🎙️ Corrected Analysis - Imagination Podcast Transcripts")
    print("🔍 Using Actual Methods from Existing Components")
    print("=" * 70)
    ...
    # Analyze each transcript using correct methods
    for transcript_file in transcript_files:
        ...
        # Analyze transcript using correct methods
        analysis_result = analyze_with_correct_methods(transcript_text, title, video_id)
        if analysis_result:
    ...
    if all_analyses:
        results_file = Path("data/outputs/analysis/imagination_podcast_corrected_analysis.json")
