...
class Phase95MCPServer(Phase9MCPServer):
    ...
    async def test_youtube_adapter(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "error",
                "error": {"code": 500, "message": f"YouTube adapter test failed: {e}"},
            }
    ...
    async def test_web_adapter(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "error",
                "error": {"code": 500, "message": f"Web adapter test failed: {e}"},
            }
    ...
    async def test_pdf_adapter(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "error",
                "error": {"code": 500, "message": f"PDF adapter test failed: {e}"},
            }
    ...
    async def test_multi_source_run(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            job_id = await self.enhanced_runner.start_job(
                sources=sources, job_label="Phase 9.5.0 Test Run"
            )
            ...
            return {
                "status": "error",
                "error": {"code": 500, "message": f"Multi-source run test failed: {e}"},
            }
    ...
    async def run_phase_9_5_0_smoke(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Phase 9.5.0 smoke test completed: {results['summary']['passed']}/{results['summary']['total_tests']} passed"  # noqa: E501
            )
        ...
        phase9_5_0_tools = [
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "transcript_mode": {
                            "type": "string",
                            "enum": ["autosubs", "official", "whisper_local"],
                        },
                    },
                },
            },
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "urls": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "PDF URLs to extract",
                        },
                        "ocr_required": {
                            "type": "boolean",
                            "description": "Require OCR processing",
                        },
                        "auto_retry": {
                            "type": "boolean",
                            "description": "Auto-retry failed extractions",
                        },
                    },
                },
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "job_label": {
                            "type": "string",
                            "description": "Label for the test job",
                        }
                    },
                },
            },
    ...
    async def execute_tool(
        ...
        try:
            ...
            return {
                "status": "error",
                "error": {"code": 500, "message": f"Tool execution failed: {e}"},
            }
