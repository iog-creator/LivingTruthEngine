...
def create_manifest(docs: List[Dict[str, Any]], flags: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def create_metrics(docs: List[Dict[str, Any]], manifest: Dict[str, Any]) -> Dict[str, Any]:
    """
