...
class AdvancedNotebookAgent:
    ...
    def __init__(
        ...
        self.embedding_model = (
            embedding_model or self.config.model.LMSTUDIO_EMBEDDING_MODEL_QWEN3
        )
    ...
    def _setup_summarizer(self):
        ...
        try:
            ...
            Comprehensive Summary:"""  # noqa: E501
    ...
    def _setup_study_guide_generator(self):
        ...
        try:
            ...
            Study Guide:"""  # noqa: E501

            study_guide_prompt = PromptTemplate(
                template=study_guide_template, input_variables=["content"]
            )
    ...
    def _setup_document_summarizer(self):
        ...
        try:
            ...
            doc_summary_prompt = PromptTemplate(
                template=doc_summary_template, input_variables=["document"]
            )
    ...
    def _setup_research_generator(self):
        ...
        try:
            ...
            Research Report:"""  # noqa: E501

            research_prompt = PromptTemplate(
                template=research_template, input_variables=["topic"]
            )
    ...
    def build_advanced_rag_system(self) -> None:
        ...
        try:
            # Vector store
            vectorstore = FAISS.from_texts(["Initial document"], self.embeddings)
            ...
            bm25_retriever = BM25Retriever.from_texts(["Initial document"])
    ...
    def setup_enhanced_agent(self) -> None:
        ...
        try:
            tools = [create_youtube_transcript_tool(str(self.sources_dir))]
