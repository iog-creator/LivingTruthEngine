...
def load_visualization_data():
    ...
    data = {"network_graphs": [], "timeline_data": [], "statistics": {}}
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        html.H1(
                            "Living Truth Engine - Enhanced Analysis Dashboard",
                                                        ...
                                                        dbc.Row(
                                                            [
                                                                dbc.Col(
                                                                    [
                                                                        html.Label(
                                                                            "Visualization Type:"  # noqa: E501
                                                                        ),
                                                                        dcc.Dropdown(
                                                                            id="visualization-type",
                                                                            options=[
                                                                                {
                                                                                    "label": "3D Network Graph",  # noqa: E501
                                                                                    "value": "network_3d",  # noqa: E501
                                                                                },
                                                                                {
                                                                                    "label": "2D Network Graph",  # noqa: E501
                                                                                    "value": "network_2d",  # noqa: E501
                                                                                },
                                                                                {
                                                                                    "label": "Timeline Analysis",  # noqa: E501
                                                                                    "value": "timeline",  # noqa: E501
                                                                                },
                                                                                {
                                                                                    "label": "Centrality Analysis",  # noqa: E501
                                                                                    "value": "centrality",  # noqa: E501
                                                                                },
                                                                                {
                                                                                    "label": "Claims Verification",  # noqa: E501
                                                                                    "value": "claims",  # noqa: E501
                                                                                },
                                                                                {
                                                                                    "label": "Statistics Overview",  # noqa: E501
                                                                                    "value": "stats",  # noqa: E501
                                                                                },
                                                                            ],
                                                                            value="network_3d",
                                                                        ),
                                                                ...
                                                                dbc.Col(
                                                                    [
                                                                        ...
                                                                        dcc.Dropdown(
                                                                            id="data-file",
                                                                            placeholder="Select a data file...",  # noqa: E501
                                                                        ),
                                                                    ],
                                                                    width=6,
                                                                ),
                                                                ...
                                                                dbc.Col(
                                                                    [
                                                                        ...
                                                                        dcc.Checklist(
                                                                            ...
                                                                            options=[
                                                                                {
                                                                                    "label": "Enable OCR on demand",  # noqa: E501
                                                                                    "value": "ocr",  # noqa: E501
                                                                                },
                                                                                {
                                                                                    "label": "Allow HF burst",  # noqa: E501
                                                                                    "value": "hf_burst",  # noqa: E501
                                                                                },
                                                                            ],
                                                                            value=[],
                                                                        ),
...
@app.callback(
    [Output("data-file", "options"), Output("data-file", "value")],
...
def update_file_options(n_clicks, n_intervals):
    ...
    options = [
        {
            "label": f"{item['name']} ({item['timestamp'].strftime('%Y-%m-%d %H:%M')})",
            "value": item["name"],
        }
...
def update_visualization(viz_type, filename):
    """Update primary visualization figure; other panels update via separate callbacks."""  # noqa: E501
    if not filename:
        return go.Figure()
...
@app.callback(
    Output("refresh-runs-btn", "children"), Input("refresh-runs-btn", "n_clicks")
)
...
@app.callback(Output("refresh-btn", "children"), [Input("refresh-btn", "n_clicks")])
...
async def api_start_youtube_run(request: Request):
    """Start a YouTube analysis run via MCP with toggle propagation and human-friendly naming."""  # noqa: E501
    try:
        ...
        if not hub:
            return {
                "status": "error",
                "error": {"code": "mcp_unavailable", "msg": "MCP server not available"},
            }
        ...
        try:
            ...
            _asyncio.create_task(
                activity_bus.emit("llm", "working", {"stage": "start_run"})
            )
        except (ImportError, ModuleNotFoundError, RuntimeError):
            pass
...
async def api_execute_tool(request: Request):
    try:
        ...
        if not tool_name:
            return {
                "status": "error",
                "error": {"code": "invalid_request", "msg": "tool_name is required"},
            }
        hub = _get_hub_server()
        if not hub:
            return {
...
async def api_ai_chat(request: Request):
    try:
        ...
        if not message:
            return {
                "status": "error",
                "error": {"code": "invalid_request", "msg": "message is required"},
            }
        ...
        try:
            ...
            _asyncio.create_task(
                activity_bus.emit(
                    "llm", "inference", {"context_run_id": context_run_id}
                )
            )
        except (ImportError, ModuleNotFoundError, RuntimeError):
            pass
        ...
        try:
            ...
            _asyncio.create_task(
                activity_bus.emit("llm", "done", {"context_run_id": context_run_id})
            )
        except (ImportError, ModuleNotFoundError, RuntimeError):
            pass
    ...
    try:
        ...
        async for event in activity_bus.subscribe():
            await websocket.send_json(
                {"ai_type": event.ai_type, "status": event.status, "meta": event.meta}
            )
        ...
        try:
            await websocket.send_json(
                {"ai_type": "system", "status": "error", "meta": {"msg": str(e)}}
            )
