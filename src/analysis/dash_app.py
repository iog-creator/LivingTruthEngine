...
@app.callback(
    [Output("visualization-graph", "figure"), Output("data-info", "children")],
    [Input("visualization-type", "value"), Input("data-file", "value")],
)
def update_visualization(viz_type, filename):
    ...
    if viz_type == "network":
        ...
        fig = go.Figure()
        fig.add_annotation(
            text="Visualization type not implemented yet",
            xref="paper",
            yref="paper",
            x=0.5,
            y=0.5,
