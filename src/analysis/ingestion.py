...
class IngestionPipeline:
    ...
    def _collect_documents(self, channel: Optional[str]) -> List[Document]:
        """Collect Documents from organized transcripts (transcript.txt and notes.md)."""  # noqa: E501
        docs: List[Document] = []
    ...
    def ingest(
        ...
        try:
            ...
            # LangChain PGVector does not expose explicit upsert; using similarity search triggers implicit table creation  # noqa: E501
